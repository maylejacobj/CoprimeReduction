...
- `SerrePairs.m` Contains code related to Serre pairs, including `IsSerrePair.m`, which checks whether a pair of Serre curves forms an elliptic curve pair. The result is rigorous when true and heuristic when false. This file also includes code related to the coprimality constant for Serre pairs.
